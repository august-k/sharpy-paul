...
from sharpy.plans.acts.zerg import ZergUnit, ZergExpand, AutoOverLord
from sharpy.plans.acts import CancelBuilding
    ...
    def __init__(self):
        ...
        opening = SequentialList(
            [
                ...
                ZergExpand(2),
                Step(
                    RequiredAll([RequiredSupply(14), RequiredMinerals(130)]),
                    StepBuildGas(1),
                ),
                Step(None, ZergUnit(UnitTypeId.DRONE, to_count=14)),
        ...
        worker_distribution = SequentialList(
            [
                Step(
                    ...
                    skip=RequiredUnitExists(
                        UnitTypeId.HATCHERY, 2, include_killed=True,
                    ),
                ),
                Step(
                    RequiredUnitExists(UnitTypeId.EXTRACTOR),
                    ...
                    skip=RequiredAny(
                        [
                            RequiredTechReady(
                                UpgradeId.ZERGLINGMOVEMENTSPEED, percentage=0.01
                            ),
                            RequiredGas(96),
                        ]
                    ),
